...
const FeedSection = () => {
    ...
    return <section className="p-md-5" id="feedSection">
        ...
        <div className="row">
            ...
            <div className=" container-fluid d-none d-md-block col-md-3 locationInput">
                    <input className="form-control mb-3" type="text" placeholder="Noida, India" aria-label="default input example" />
                    <p className="">
                        <svg className="mx-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
